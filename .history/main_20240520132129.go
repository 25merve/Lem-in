...
func main() {
	...
	// Karıncaların yollarını bulmak ve hareketlerini göstermek için BFS kullanılır
	tumYollar := grafik.bfs.TumYollar(grafik.BaslangicDugumID, grafik.BitisDugumID)
	if len(tumYollar) == 0 {
