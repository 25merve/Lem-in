...
func main() {
	...
	if len(filteredPaths) == 0 {
		fmt.Println("Hata: Geçerli bir yol yok.") // Error: No valid path
		return
	}
...
// Function to filter paths to ensure no overlapping
func filterPaths(paths [][]int, antCount int) [][]int {
	filteredPaths := [][]int{}
	occupiedNodes := make(map[int]bool)
...
// Function to assign paths to ants
